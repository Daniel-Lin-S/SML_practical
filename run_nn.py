...
def nn_grid_search_one(
    ...
    for i, params in enumerate(params_list):
        ...
        train_losses, val_losses, val_accs = run_training_loop(
            num_epochs=n_epochs,
        ...
        _, val_acc = validate(
            model, val_loader=val_loader, loss_function=loss_function, device=device
        )
...
def main():
    ...
    for method_names in METHOD_DICT.keys():
        ...
        # run the grid search
        best_params = nn_grid_search_one(
            model,
            params_list,
            train_loader,
            val_loader,
